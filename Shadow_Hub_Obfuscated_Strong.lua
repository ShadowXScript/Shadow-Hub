...
_3a2593:CreateToggle({
    ...
    Callback = function(_689202)
        _08c31e:Notify("Shadow Hub", "Auto Dunk " .. (_689202 and "Enabled" or "Disabled"), 3)
...
_3a2593:CreateToggle({
    ...
    CurrentValue = false,
    Callback = function(_689202)
        _08c31e:Notify("Shadow Hub", "Auto Dribble " .. (_689202 and "Enabled" or "Disabled"), 3)
...
_3a2593:CreateToggle({
    ...
    CurrentValue = false,
    Callback = function(_689202)
        _08c31e:Notify("Shadow Hub", "Auto Steal " .. (_689202 and "Enabled" or "Disabled"), 3)
...
_3a2593:CreateToggle({
    ...
    CurrentValue = false,
    Callback = function(_689202)
        _08c31e:Notify("Shadow Hub", "Auto Block " .. (_689202 and "Enabled" or "Disabled"), 3)
...
_701a6d:CreateToggle({
    ...
    CurrentValue = false,
    Callback = function(_689202)
        _08c31e:Notify("Shadow Hub", "No Cooldown Ability " .. (_689202 and "Enabled" or "Disabled"), 3)
...
_701a6d:CreateToggle({
    ...
    CurrentValue = false,
    Callback = function(_689202)
        _08c31e:Notify("Shadow Hub", "Auto Zone " .. (_689202 and "Enabled" or "Disabled"), 3)
...
_701a6d:CreateToggle({
    ...
    CurrentValue = false,
    Callback = function(_689202)
        _08c31e:Notify("Shadow Hub", "Auto Awaken " .. (_689202 and "Enabled" or "Disabled"), 3)
        while _689202 and task.wait(2) do
