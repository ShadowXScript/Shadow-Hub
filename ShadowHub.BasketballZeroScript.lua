...
local Window = Luna:CreateWindow({
	...
	LoadingEnabled = true,
	LoadingTitle = "Shadow Hub | Loading....", -- Header for loading screen
	LoadingSubtitle = "by ShadowDev", -- Subtitle for loading screen

	ConfigSettings = {
		ConfigFolder = "Shadow Hub" -- The Name Of The Folder Where Luna Will Store Configs For This Script. DO NOT ADD A SLASH
	},
	...
	KeySettings = {
		...
		Key = {"I AM ATOMIC"}, -- List of keys that will be accepted by the system, please use a system like Pelican or Luarmor that provide key strings based on your HWID since putting a simple string is very easy to bypass
		SecondAction = {
			Enabled = true, -- Set to false if you do not want a second action,
			Type = "Join Discord For Key",
			Parameter = "https://discord.gg/nz442RKQBd"
		}
	}
})
...
MainTab:CreateToggle({
  ...
  Callback = function(v)
    notify("Auto Dunk", v)
    while v and task.wait(dS.Dunk or 0.5) do
      pcall(function()
...
-- Spin & Zone
local Tab = Window:CreateTab({
	Name = "Spin Style & Zone",
	Icon = "view_in_ar",
	ImageSource = "Material",
	ShowTitle = true -- This will determine whether the big header text in the tab will show
})
Tab:CreateSection("Spin Style & Zone")
