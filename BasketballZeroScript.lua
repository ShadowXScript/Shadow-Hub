...
MainTab:CreateToggle({
  ...
  Callback = function(v)
    ...
    while v and task.wait(0.5) do
      pcall(function()
        if animator and dunkAnims[index] then
          local anim = Instance.new("Animation")
          anim.AnimationId = "rbxassetid://" .. dunkAnims[index]
          local track = animator:LoadAnimation(anim)
          track:Play()
          index = index + 1
          if index > #dunkAnims then index = 1 end
        end
...
MainTab:CreateToggle({
  ...
  Callback = function(v)
    ...
    while v and task.wait(dS.Dribble) do
      pcall(function()
        if animator and dribbleAnims[index] then
          local anim = Instance.new("Animation")
          anim.AnimationId = "rbxassetid://" .. dribbleAnims[index]
          local track = animator:LoadAnimation(anim)
          track:Play()
          index = index + 1
          if index > #dribbleAnims then index = 1 end
        end
