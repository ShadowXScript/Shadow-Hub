local success, Luna = pcall(function()
    return loadstring(game:HttpGet("https://raw.githubusercontent.com/Nebula-Softworks/Luna-Interface-Suite/main/source.lua", true))()
end)

if not success or not Luna then
    warn("Failed to load Luna UI library. Please check the URL or your internet connection.")
    return
end
...
local name = "Shadow Hub | Basketball Zero"

Luna:Notification({ 
    Title = "Loaded",
    Icon = "notifications_active",
    ImageSource = "Material",
    Content = name .. " is now loaded!",
    Duration = 5
})