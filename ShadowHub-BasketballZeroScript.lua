...
AbilitiesTab:CreateSection("Abilities")
...
-- Spin & Zone
local SpinTab = Window:CreateTab("Spin & Zone", 4483362458)
SpinTab:CreateSection("Spin Actions")
...
-- Style Selection
local StyleTab = Window:CreateTab("FE Style [Need Copycat]", 7734068321)
StyleTab:CreateSection("Select Style")
...
-- Zone Style Selection

local ZoneTab = Window:CreateTab("FE Zone [Need Copycat]", 7734068321)
ZoneTab:CreateSection("Select Zone")
...
local SettingsSection = SettingsTab:CreateSection("Delay Settings")
